                        ...
                        <ul>
                            <li class="flex">
                                ...
                                <div class="m-5">
                                    ...
                                    <p class="text-gray-400">Ramblers, Villa Esperanza Molino 2</p>
                            ...
                            <li class="flex">
                                ...
                                <div class="m-5">
                                    ...
                                    <p class="text-gray-400">Mobile:09516658492</p>
                                    <p class="text-gray-400">Email:kenalcalahe11.h@gmail.com </p>
                                </div>
                            </li>
                            <li class="flex">
                                ...
                                <div class="m-5">
                                    ...
                                    <p class="text-gray-400">bc.ken.alcala@cvsu.edu.ph </p>
                                </div>
                            </li>
                        </ul>
                    </div>
